    ...
    return (
        <div className='min-[1921px]:max-w-[1920px] mx-auto'>
            <div className='relative z-20'>
                <a href="#">
                    <img className='lg:block hidden w-fit' src="./assets/images/png/logo-mark.png" alt="logo" />
                </a>
            ...
            <div className=" lg:hidden  flex justify-between pt-4 bg-[#0046AD] px-5">
                <a href="#">
                    <img className='max-w-[105px] lg:hidden block' src="./assets/images/png/logo.png" alt="logo" />
                </a>
