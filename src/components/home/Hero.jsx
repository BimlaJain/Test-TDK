...
const Hero = () => {
    return (
        <div>
            <div className="bg-cover bg-no-repeat max-2xl:bg-contain bg-top max-xl:bg-cover xl:h-[930px] lg:h-[1061px] h-[703px]" style={{ backgroundImage: `url(./assets/images/webp/hero-bg.webp)` }}>
                <Header />
